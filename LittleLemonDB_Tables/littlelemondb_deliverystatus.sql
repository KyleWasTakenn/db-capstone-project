...
CREATE TABLE `deliverystatus` (
  ...
  KEY `AssignedStaffID_idx` (`AssignedStaffID`),
  CONSTRAINT `AssignedStaffID` FOREIGN KEY (`AssignedStaffID`) REFERENCES `staff` (`StaffID`)
...
INSERT INTO `deliverystatus` VALUES (301,'18:45:00','Delivered',102),(302,'19:20:00','Preparing',101),(303,'20:15:00','Cancelled',103);
